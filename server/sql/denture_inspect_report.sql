...
--
-- Table structure for table `inspect_report`
--
...
--
-- Dumping data for table `inspect_report`
--

LOCK TABLES `inspect_report` WRITE;
/*!40000 ALTER TABLE `inspect_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `inspect_report` ENABLE KEYS */;
UNLOCK TABLES;
