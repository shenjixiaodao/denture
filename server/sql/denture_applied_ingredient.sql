...
--
-- Table structure for table `applied_ingredient`
--
...
--
-- Dumping data for table `applied_ingredient`
--

LOCK TABLES `applied_ingredient` WRITE;
/*!40000 ALTER TABLE `applied_ingredient` DISABLE KEYS */;
/*!40000 ALTER TABLE `applied_ingredient` ENABLE KEYS */;
UNLOCK TABLES;
