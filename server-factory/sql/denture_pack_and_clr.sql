...
--
-- Table structure for table `pack_and_clr`
--
...
--
-- Dumping data for table `pack_and_clr`
--

LOCK TABLES `pack_and_clr` WRITE;
/*!40000 ALTER TABLE `pack_and_clr` DISABLE KEYS */;
/*!40000 ALTER TABLE `pack_and_clr` ENABLE KEYS */;
UNLOCK TABLES;
