...
--
-- Dumping data for table `inspect_item`
--

LOCK TABLES `inspect_item` WRITE;
/*!40000 ALTER TABLE `inspect_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `inspect_item` ENABLE KEYS */;
UNLOCK TABLES;
