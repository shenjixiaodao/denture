...
--
-- Table structure for table `procedure_group`
--
...
--
-- Dumping data for table `procedure_group`
--

LOCK TABLES `procedure_group` WRITE;
/*!40000 ALTER TABLE `procedure_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `procedure_group` ENABLE KEYS */;
UNLOCK TABLES;
